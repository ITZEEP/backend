...
public class TenantStep1DTO {
      ...
      @NotNull(message = "입주 예정일")
      private LocalDate expectedMoveInDate;

      @ApiModelProperty(
              value = "계약 기간",
              example = "YEAR_2",
              allowableValues = "YEAR_1,YEAR_2,YEAR_3,YEAR_4,YEAR_5")
      @NotNull(message = "계약 기간")
